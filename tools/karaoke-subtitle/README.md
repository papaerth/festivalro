...
- **윈도우 미디어 플레이어에서 MOV가 안 열림(0xC00D5212, ap4h)**: ProRes 4444는 편집기용 코덱이라 윈도우 기본 플레이어에는 디코더가 없습니다. 정상입니다. 결과 확인은 **미리보기 mp4**(기본 켜짐)로 하세요. [완성본 재생]은 미리보기 mp4가 있으면 그것을 열고, 없으면 만들어서 재생할지 묻습니다.
